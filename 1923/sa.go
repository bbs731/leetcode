...
/*
抄的答案： https://github.com/EndlessCheng/codeforces-go/blob/master/leetcode/weekly/248/d/d.go

这道题，属于广义 SAM
https://oi-wiki.org/string/general-sam/  但是不知道如何用 general sam 来解, 会 outof memory


需要联系， 利用SAM 和 general SAM 来解题
 */
...
func longestCommonSubpath(_ int, paths [][]int) (ans int) {
	...
	return sort.Search(minLen, func(limit int) bool {
		...
		for i := 1; i < n; i++ {
			...
			cnt := 0 // 注意这里喽！ 是要计算连续 m 个后缀的 lcp 不小于 limit
